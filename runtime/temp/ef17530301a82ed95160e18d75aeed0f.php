<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:37:"./template/default/picture/index.html";i:1530848282;s:37:"./template/default/public/header.html";i:1532046846;s:41:"./template/default/public/breadcrumb.html";i:1526267826;s:37:"./template/default/public/footer.html";i:1532165972;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="main">
	<div class="picture_list_container">
		...
		<?php if(is_array($lists) || $lists instanceof \think\Collection): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
			<li class="trans_3">
				<a href="<?php echo $vo['url']; ?>" class="pic"><img class="lazy" data-original="<?php echo thumb($vo['image_url'],270,180,3); ?>" src="__JASON__/static/images/pic_loading_bg.png" alt="<?php echo $vo['title']; ?>"></a>
