<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:36:"./template/default/picture/show.html";i:1531452309;s:37:"./template/default/public/header.html";i:1532046846;s:41:"./template/default/public/breadcrumb.html";i:1526267826;s:37:"./template/default/public/footer.html";i:1532165972;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="main">
	<div class="page_left">
		<div class="detail_container trans_3">
			<h1 style="color:#159f9f;text-shadow: #eeeeee 3px 4px 5px"><?php echo $data['title']; ?></h1>
			<div class="date_hits"><span><i class="fa fa-clock-o fa-1x" aria-hidden="true"></i> <?php echo format_datetime($data['create_time']); ?></span><span><i class="fa fa-heart-o fa-1x" aria-hidden="true"></i> <?php echo $data['hits']; ?> ℃</span><span><i class="fa fa-comments-o fa-1x" aria-hidden="true"></i> <a href="#SOHUCS" id="changyan_count_unit"></a></span></div>
			...
			<?php endif; ?>
			<div class="prev_next">
				<span class="prev"><i class="fa fa-chevron-circle-left" aria-hidden="true" style="color:#5F9EA0"></i> <a href="<?php echo $data['prev']['url']; ?>"><?php echo $data['prev']['title']; ?></a></span>
				<span class="next"><i class="fa fa-chevron-circle-right" aria-hidden="true" style="color:#5F9EA0"></i> <a href="<?php echo $data['next']['url']; ?>"><?php echo $data['next']['title']; ?></a></span>
				<div class="clear"></div>
			</div>
			
			<div class="commont_containr">
				<!-- 打赏 -->
				<div id="cyReward" role="cylabs" data-use="reward" style="margin-left:40%;margin-top:10px;"></div>
				<!--【畅言】表情评价-->
...
<!-- 分享JS -->
<script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":["mshare","qzone","tsina","weixin","renren","tieba","sqq","fbook","twi","linkedin","copy","print"],"bdPic":"","bdStyle":"0","bdSize":"16"},"slide":{"type":"slide","bdImg":"2","bdPos":"right","bdTop":"96.5"}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
