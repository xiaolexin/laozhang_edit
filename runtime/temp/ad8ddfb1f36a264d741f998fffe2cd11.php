<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:36:"./template/default/picture/list.html";i:1531193217;s:37:"./template/default/public/header.html";i:1532046846;s:41:"./template/default/public/breadcrumb.html";i:1526267826;s:37:"./template/default/public/footer.html";i:1532165972;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="main index_main">
		...
		<ul class="picture_list_container">
			...
			<li class="trans_3">
				...
				<div class="fade"><span class="zhezhaocontent">
					<?php echo mb_substr($vo['description'],1,60,'utf-8')."...";?></span></div><img class="lazy" data-original="<?php echo thumb($vo['image_url'],330,220,1); ?>" src="__JASON__/static/images/pic_loading_bg.png"></a>
				<h2 class="title"><a href="<?php echo $vo['url']; ?>"><?php if($vo['is_top']==1): ?><span class="top">置顶</span><?php endif; ?><?php echo mb_substr($vo['title'],0,14,'UTF-8')."...";?></a></h2>
				<div class="date_hits">
					<p class="date"><span style="margin-left: 0px;"><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo format_datetime($vo['create_time']); ?></span>&nbsp;<span class="hits" style="margin-left: 50%;"><i class="layui-icon" title="点击量">&#xe62c;</i> <?php echo $vo['hits']; ?>℃</span></p>
				</div>
			</li>
			<?php endforeach; endif; else: echo "" ;endif; ?>
		</ul>
	...
	<div class="page_right">
		<div class="second_categorys_container">
			<h3><i class="fa fa-list" aria-hidden="true" style="color:gray;"></i> 栏目导航</h3>
			<ol class="seond_category trans_3">
				...
				<li <?php if(\think\Request::instance()->param('category_id')==$vo['id']): ?>class="selected"<?php endif; ?>><a href="<?php echo $vo['url']; ?>" class="layui-btn layui-btn-primary trans_1"><?php echo $vo['name']; ?></a></li>
				<?php endforeach; endif; else: echo "" ;endif; ?>
			</ol>
		</div>
		<?php if(!(empty($recommend_list) || ($recommend_list instanceof \think\Collection && $recommend_list->isEmpty()))): ?>
		<div class="recommend_list">
			<h3><i class="fa fa-star-half-o" aria-hidden="true" style="color:gold"></i> 推荐文章</h3>
