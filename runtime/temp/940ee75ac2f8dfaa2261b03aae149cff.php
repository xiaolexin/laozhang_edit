<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"/home/wwwroot/default/myblog/application/admin/view/index/home.tpl.php";i:1530846346;s:72:"/home/wwwroot/default/myblog/application/admin/view/public/toper.tpl.php";i:1531233332;}*/ ?>
﻿<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
    ...
    <div class="layui-tab-content index_panel_container">
        ...
        <div class="right">
           <blockquote class="layui-elem-quote update_log"> 
                <p style="font-weight: bold;">v1.1.6更新日志2018-7-5</p>
                <p>
                    1、新增后台编辑器选择ueditor<br>
                    2、留言部分增加热门的获取浏览器版本等信息功能 <br>
                    3、首页设置为默认的图片模型，简洁好看 <br>
                </p> 
                <hr>
