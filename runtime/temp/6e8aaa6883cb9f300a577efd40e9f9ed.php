<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"/home/wwwroot/default/myblog/application/admin/view/setting/base.tpl.php";i:1530851851;s:72:"/home/wwwroot/default/myblog/application/admin/view/public/toper.tpl.php";i:1531233332;}*/ ?>
﻿<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
...
<div class="layui-tab layui-tab-brief main-tab-container" lay-filter="main-tab">
    ...
    <div class="layui-tab-content">
      <div class="layui-tab-item <?php if(input('param.tab')==1) echo 'layui-show'; ?>">  
        ...
        <?php echo Form::file('logo',$setting['logo'],'网站logo','网站logo，将显示在网站前台','','images','','图片','logo');//echo Form::file('qr_code',$setting['qr_code'],'二维码','公众号二维码，将显示在网站前台','','images','','图片','qr_code');?>
        ...
        <?php echo Form::input('text','threshold',$setting['threshold'],'分词概率','从0到1，文章标题分词的概率','请输入分词概率');//echo Form::radio('editor',$setting['editor']?$setting['editor']:'umeditor','后台编辑器','后台内容编辑所用的富文本编辑器',array('umeditor'=>'umeditor','layedit'=>'layedit'));?> 
